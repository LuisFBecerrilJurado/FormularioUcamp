export function validarDatos(input){
    ...
    if (input.validity.valid) {
        ...
        input.parentElement.querySelector(".input__mensage-error").innerHTML = " ";
    } else {
        input.parentElement.classList.add("input__container--invalid");
        input.parentElement.querySelector(".input__mensage-error").innerHTML = mostrarMensajeError(tipoInput, input);
    }
}
...
function validarFecha(input){
    ...
    let mensaje = "";
    if (!validarMayorEdad(fechaCapturada)) {
